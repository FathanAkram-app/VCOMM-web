                ...
                <div className="grid gap-5">
                  ...
                  <div className="space-y-2">
                    <Label htmlFor="reg-station" className="text-sm font-bold uppercase">
                      CURRENT STATION / DEPLOYMENT AREA
                    </Label>
                    <Input
                      id="reg-station"
                  ...
                  {/* Security Clearance */}
                  <div className="space-y-2">
                    <Label htmlFor="reg-security" className="text-sm font-bold uppercase">
                    ...
                    >
                      <SelectTrigger id="reg-security" className="bg-muted border-accent">
