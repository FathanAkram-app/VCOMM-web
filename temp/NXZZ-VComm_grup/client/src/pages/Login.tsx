...
// Import sistem otentikasi sederhana
import { simpleLogin, isLoggedIn } from "../lib/simpleAuth";
...
export default function Login() {
  ...
  const handleLogin = (e: React.FormEvent) => {
    ...
    try {
      // Coba login dengan sistem otentikasi sederhana
      const userData = simpleLogin(username, password);
