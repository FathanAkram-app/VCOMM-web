  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center bg-black/80 z-50">
      <div className="bg-background border-2 border-accent rounded-sm overflow-hidden w-5/6 max-w-sm shadow-2xl">
        <header className="military-header px-4 py-3 text-center">
          <h3 className="text-lg font-bold uppercase tracking-wider">INCOMING TRANSMISSION</h3>
        </header>
        ...
        <div className="p-6 flex flex-col items-center">
          ...
          <div className="flex justify-around w-full mt-2 gap-4">
            <Button
              variant="destructive"
              size="lg"
              className="military-button flex-1 h-16 rounded-sm border border-destructive uppercase font-bold"
              onClick={rejectCall}
            ...
            <Button
              variant="default"
              size="lg"
              className="military-button flex-1 h-16 rounded-sm border uppercase font-bold"
              onClick={answerCall}
              disabled={isCallLoading}
            >
